          ...
          <Row className='pb-5'> 
            ...
            <Col md={6} className='mt-lg-5 pt-5'>
              ...
              <button className="ff_roboto fw_400 fs_15 text-uppercase text-white bg_none latest_btn rounded-pill mt-5">
                Latest episode  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.5176 22C18.0404 22 22.5176 17.5228 22.5176 12C22.5176 6.47715 18.0404 2 12.5176 2C6.99473 2 2.51758 6.47715 2.51758 12C2.51758 17.5228 6.99473 22 12.5176 22Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.5176 16L16.5176 12L12.5176 8" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M8.51758 12H16.5176" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
            </Col>
            <Col md={6} className='mt-lg-5 pt-5'>
