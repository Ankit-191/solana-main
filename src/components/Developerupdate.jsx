            ...
            <Col lg={6}>
              <div className="bg_19161C p-2  p-sm-5 h-100 d-flex flex-column justify-content-between border_14">
                <div>
                  ...
                  <p className="ff_Helvetica fw_400 fs_17 clr_C4C4C4">
                ...
                <div className="bg-black d-flex justify-content-between email p-2 rounded-pill mt-5 mt-lg-0">
                  <input
                    type="email"
                    placeholder="Email"
                    className="bg-black border-0 ps-2 outline-none w-75 ff_roboto fw_600 fs_20 clr_848895 "
                  />
                  <button className="btn_signup rounded-pill bg_14F195 ff_roboto fw_400 fs_15 text-black text-uppercase border-0">
                    Sign up
                  </button>
                </div>
              </div>
            ...
            <Col lg={6}>
              <div className="bg_19161C p-2 mt-4 mt-lg-0 p-sm-5  h-100 d-flex flex-column justify-content-between border_14">
                <div>
                  ...
                  <p className="ff_Helvetica fw_400 fs_18 clr_C4C4C4">
                ...
                <div className="mt-md-5 mt-2 d-flex gap-4">
                  <button className="ff_roboto fw_400 fs_15 btn_youbtube text-uppercase rounded-pill bg-black text-white">
                    YouTube{" "}
                    <svg
                      className="ms-2"
                      width="27"
