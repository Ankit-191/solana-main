                ...
                <Row>
                    <Col lg={6}>
                        <div className='bg_19161C p-2  p-sm-5 h-100 d-flex flex-column justify-content-between'>
                            ...
                            <div className='bg-black d-flex justify-content-between email p-2 rounded-pill mt-5 mt-lg-0' >
                                <input type="email" placeholder='Email' className='bg-black border-0 ps-2 outline-none w-75 ff_roboto fw_600 fs_20 clr_848895 ' />
                                <button className='btn_signup rounded-pill bg_14F195 ff_roboto fw_400 fs_15 text-black text-uppercase border-0'>Sign up</button>
                            </div>
                        </div>
                    </Col>
                    <Col lg={6}>
